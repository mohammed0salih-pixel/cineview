        ...
        <div className="mx-auto max-w-7xl px-4 pb-24 lg:px-8 fade-soft">
          ...
          <div className="mb-12 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/5 px-4 py-1.5">
                <span className="text-xs font-semibold text-white/70 uppercase tracking-[0.3em]">Project Detail</span>
              </div>
          ...
          <Tabs defaultValue="overview" className="space-y-10">
            <div className="overflow-x-auto pb-2">
              <TabsList className="inline-flex w-max rounded-full bg-white/5 p-1 backdrop-blur">
                <TabsTrigger value="overview" className="rounded-full px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/50 data-[state=active]:bg-white data-[state=active]:text-black">Overview</TabsTrigger>
                <TabsTrigger value="visual" className="rounded-full px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/50 data-[state=active]:bg-white data-[state=active]:text-black">Visual Intelligence</TabsTrigger>
                <TabsTrigger value="cinematic" className="rounded-full px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/50 data-[state=active]:bg-white data-[state=active]:text-black">Cinematic Reading</TabsTrigger>
                <TabsTrigger value="storyboard" className="rounded-full px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/50 data-[state=active]:bg-white data-[state=active]:text-black">Storyboard</TabsTrigger>
                <TabsTrigger value="mood" className="rounded-full px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/50 data-[state=active]:bg-white data-[state=active]:text-black">Mood Direction</TabsTrigger>
                <TabsTrigger value="insights" className="rounded-full px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/50 data-[state=active]:bg-white data-[state=active]:text-black">AI Insights</TabsTrigger>
                <TabsTrigger value="export" className="rounded-full px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/50 data-[state=active]:bg-white data-[state=active]:text-black">Export</TabsTrigger>
              </TabsList>
            </div>
            ...
            <TabsContent value="overview" className="space-y-10">
              ...
              <div className="pt-2">
                <Button
                  className="bg-white/5 text-white/80 rounded-full hover:bg-white/10"
            ...
            <TabsContent value="visual" className="space-y-10">
              <section className="space-y-4">
              ...
              <div className="pt-2">
                ...
                {showVisualData && (
                  <div className="mt-8 rounded-3xl bg-white/5 p-6 text-sm text-white/70">
            ...
            <TabsContent value="cinematic" className="space-y-10">
              <section className="space-y-4">
            ...
            <TabsContent value="storyboard" className="space-y-10">
              <section className="space-y-4">
                ...
                {displayStoryboard.length ? (
                  <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {displayStoryboard.map((frame) => (
                      <div key={frame.id} className="overflow-hidden rounded-3xl bg-white/5">
            ...
            <TabsContent value="mood" className="space-y-10">
              <section className="space-y-4">
            ...
            <TabsContent value="export" className="space-y-10">
              <section className="space-y-4">
